package org.afunc.android.util.shell;
...
public final class ShellTool {
    ...
    private static volatile ShellTool instance;

    public static ShellTool instance() {
        if (instance == null) {
            synchronized (lock) {
                if (instance == null) {
    ...
    public CommandResult execCmd(String[] commands, boolean isRoot, boolean isNeedResultMsg) {
        ...
        try {
            ...
            Tools.close().closeIO(os, successResult, errorResult);
            if (process != null) {
                process.destroy();
            }
        }
