...
public final class ExternalStorageTool {

    public static final String SD_CARD = "sdCard";
    public static final String EXTERNAL_SD_CARD = "externalSdCard";

    private static final Object lock = new Object();
    private static volatile ExternalStorageTool instance;

    private ExternalStorageTool() {
    }

    public static ExternalStorageTool instance() {
        if (instance == null) {
            synchronized (lock) {
                if (instance == null) {
                    instance = new ExternalStorageTool();
                }
            }
        }
        return instance;
