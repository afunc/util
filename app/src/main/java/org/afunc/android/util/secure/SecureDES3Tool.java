...
public final class SecureDES3Tool {
    ...
    private static volatile SecureDES3Tool instance;

    private SecureDES3Tool() {
    }
     ...
     * @return
     */
    public byte[] encryptMode(byte[] src, String password) {
        try {
     ...
     * @return
     */
    public byte[] decryptMode(byte[] src, String password) {
        try {
